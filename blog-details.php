...
<head>
    ...
    include("link.php");
    ?>
    <title>Pagosa Cabin | Blog Details</title>
</head>
    <?php
    include("header.php");
    ?>
                    ...
                    <div class="side-bar-wrap">
                        ...
                        <div class="side-bar-widget">
                            ...
                            <div class="widget-popular-post">
                                ...
                                <article class="item">
                                    <a href="https://templates.hibootstrap.com/atoli/default/news-details.html" class="thumb">
                                        <span class="full-image cover bg3" role="img"></span>
                                    </a>
                                    <div class="info">
                                        <h4 class="title-text">
                                            <a href="https://templates.hibootstrap.com/atoli/default/news-details.html">
